            ...
            with col_r2:
                ...
                if R**2 >= o_x**2:
                    ...
                    if calc_rot:
                        ...
                        if Cu == 0:
                            st.warning("Cohesion is 0, so resisting moment is 0.")
                        ...
                        if M_drv_total > 0:
                            ...
                            if FS < 1.0: st.error("Slope is UNSTABLE")
                            elif FS < 1.5: st.warning("Slope is Marginally Stable")
                            else: st.success("Slope is Stable")
                        else:
                            st.info("Total driving moment is zero or negative.")
                else:
            ...
            with col_s2:
                ...
                if num_slices > 0:
                    ...
                    for i in range(num_slices):
                        ...
                        ax_slice.text(mid_x, mid_y - 0.5, f"W={row['W (kN/m)']}\nα={row['α (deg)']}°",
                ...
                if calc_slices:
                    ...
                    with col_res2:
                        ...
                        if driving_forces != 0:
                            ...
                            if FS_slices < 1.0: st.error("Slope is UNSTABLE")
                            elif FS_slices < 1.5: st.warning("Slope is Marginally Stable")
                            else: st.success("Slope is Stable")
                        else:
    ...
    with tab_comp:
        ...
        with col_c2:
            ...
            if calc_blk:
                ...
                Pa = max((0.5 * gamma_top * (H_right**2) * Ka) - (2 * c_top * H_right * math.sqrt(Ka)), 0.0)
