...
# --- DEFAULT VALUES FROM EXAM NOTES ---
        ...
        # -------------------------------------------------
        st.markdown("---")
        if "calc_trigger" not in st.session_state:     st.session_state.calc_trigger = False  if st.button("Calculate Stress Profiles", type="primary"):     st.session_state.calc_trigger = True  if st.session_state.calc_trigger:
